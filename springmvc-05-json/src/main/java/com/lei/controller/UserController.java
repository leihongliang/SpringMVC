...
import com.lei.utils.JsonUtils;
...
public class UserController {
    ...
    public String json1() throws JsonProcessingException {
        ...
        //创建一个对象
        User user = new User(1, "洪亮_lei", 12);
    ...
    public String json2() throws JsonProcessingException {
        ...
        User user1 = new User(1, "lei_1", 12);
        User user2 = new User(2, "lei_2", 12);
        User user3 = new User(3, "lei_3", 12);
        User user4 = new User(4, "lei_4", 12);
        User user5 = new User(5, "lei_5", 12);
